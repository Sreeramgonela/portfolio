      ...
      >
        <div className={style.left_side}>
          ...
          >
            <a
              ...
              target="_blank"
              href="https://drive.google.com/file/d/1CwzuBpB3pKRemRnMLEGSk-yKnN3rMDaY/view?usp=drivesdk"
            >
        ...
        >
          <div className={style.img_section}>
            <img src={HeroImage} alt="SREERAM GONELA" className={style.hero_image} />
          </div>
        </motion.div>
      </motion.div>
    </div>
