        ...
        <div className={styles.box}>
          ...
          <div className={styles.right_section_indexing}>
            ...
            <div className={styles.symbol}>
              ...
              <p>House. 5-47, Warangal, Station Ghanpur (506143), Telangana</p>
            </div>
            ...
            <div className={styles.follow_me_section}>
              ...
              <div className={styles.account_box}>
                ...
                <div className={styles.account_icon}>
                  <a
                    href="https://www.linkedin.com/in/sreeram-gonela/"
                    target="_blank"
                ...
                <div className={styles.account_icon}>
                  <a
                    href="https://github.com/Sreeramgonela"
                    rel="noopener noreferrer"
                    target="_blank"
                  >
                ...
                <div className={styles.account_icon}>
                  <a
                    href="https://www.instagram.com/_.mr_sriram_07/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
